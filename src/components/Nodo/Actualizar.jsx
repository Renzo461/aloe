    ...
    return (
        <div className={'absolute top-0 left-0 bottom-0 right-0 flex justify-center items-center bg-black bg-opacity-40 ' + opacidad} >
            <form className='form p-4 bg-white rounded-lg'>
                <h4 className='text-center border mb-4'>ACTUALIZAR</h4>
                ...
                <div className='flex justify-between' >
                    <div className="flex-1" onClick={agregarNodo}><ButtonPS estilo="primario" texto="Agregar" espacio="mr-6" funcion={actualizar}/></div>
